# Algebraic verification of exact solutions — Problems 1–5

Independent algebraic re-derivation of every exact solution in `verification.md` Problems 1–5, confirming each satisfies the stated PDE, boundary conditions, source compatibility, and (where applicable) interface and flux continuity. The companion submission brief is `docs/submissions/0002-algebraic-verification.md`.
